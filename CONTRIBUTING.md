# Contributing to ml-synonyms-ng

ml-synonyms-ng welcomes new contributors. This document will guide you
through the process.
...
If you have questions about how to use ml-synonyms-ng, check our documentation on the [Wiki][wiki]. Alternatively, check [Stack Overflow][mlstack] to see if it has been answered there, and post your question there if not. Please tag it with MarkLogic, and AngularJS.
...
* **ml-synonyms-ng Version** - is it a named version or from our master branch
...
Fork the project [on GitHub](https://github.com/grtjn/ml-synonyms-ng/fork) and clone
your copy.

```sh
$ git clone git@github.com:username/ml-synonyms-ng.git
$ cd ml-synonyms-ng
$ git remote add upstream git://github.com/grtjn/ml-synonyms-ng.git
```
...
Go to https://github.com/username/ml-synonyms-ng and select your feature branch. Click
...
[wiki]: https://github.com/grtjn/ml-synonyms-ng/wiki
[mlstack]: http://stackoverflow.com/questions/tagged/marklogic
[issue tracker]: https://github.com/grtjn/ml-synonyms-ng/issues
